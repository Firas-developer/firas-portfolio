...
const Project = () => {
  ...
  return (
    <section className="work lg:mx-28 mx-5" id="work">
      <div className="box-container grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 relative z-20 gap-10 m-5">
        {filteredProjects.map((project, index) => (
          <div
            className="box h-full tilt shadow-gray-600 rounded-xl shadow-3xl relative my-5"
            key={index}
          >
            ...
            <div className="content hidden-on-hover p-2">
              <div className={`tag text-center p-1 start-page text-white ${project.style}`}>
                <h3 className="md:text-lg text-md font-bold">{project.name}</h3>
              </div>
